...
function renderDailyChart(){
  ...
  charts.daily = new Chart(document.getElementById('dailyChart'), {
    ...
    options: { ...chartBaseOptions(false), plugins: { ...chartBaseOptions(false).plugins, legend: { display:false } } }
  });
  document.getElementById('dailyChartLegend').innerHTML = outlets.map(o => `
    <div class="legend-item"><span class="sw" style="background:${COLORS[o]||'#8B93A0'}"></span>${BRAND_NAME[o]||o}</div>
  `).join('');
}
...
function renderMealChart(){
  ...
  document.getElementById('mealChartLegend').innerHTML = `
    <div class="legend-item"><span class="sw" style="background:#C9A24B"></span>Lunch</div>
    <div class="legend-item"><span class="sw" style="background:#4A5568"></span>Dinner</div>
  `;
}
